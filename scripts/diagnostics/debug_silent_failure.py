        ...
        if "trades" in tables:
            try:
                ...
                try:
                    ...
                    # ROLLBACK failed — connection may be in odd state,
                    # but we're about to close it anyway. Log nothing to
                    # keep the silent-failure test output clean.
                    pass
...
if dh_path.exists():
    try:
        ...
        # decision_history.jsonl exists but is unreadable / wrong shape — skip
        pass
else:

...
# ============================================================
# Day 37 note: this content was shared as `scanner/scanner.py`, but its own
# header comment says `scanner/config.py`, and `correlation_filter.py`,
# `market_scanner.py`, and `opportunity_ranker.py` all do
# `from scanner.config import ...`. Saved here under the filename those
# imports actually expect — if you already have this content at
# `scanner/scanner.py` in your repo, rename/move it (or just drop this file
# in alongside it).
# ============================================================
